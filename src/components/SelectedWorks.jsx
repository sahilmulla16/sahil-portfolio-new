...
const ProjectCard = ({ project, onClick }) => {
  ...
  return (
    ...
    >
      ...
      {project.video && <ProjectVideo src={project.video} isHovered={isHovered} />}
      
      {/* Colored Glow Accent (for client projects) */}
      {project.themeColor && (
        <div 
      ...
      <div className="relative z-10">
        ...
        <h3 className="text-2xl md:text-3xl font-display italic mb-4 group-hover:text-accent transition-colors">{project.title}</h3>
